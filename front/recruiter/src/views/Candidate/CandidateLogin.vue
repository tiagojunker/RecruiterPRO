<template>
    <div class="container-fluid">
        ...
        <div class="content">
            ...
            <h1 class="text-center">Login de Candidatos</h1>
            ...
            <form action="" class="bg-white p-4 col-sm-10 off-set-sm-1 col-md-8 offset-md-2 col-lg-6 offset-lg-3 form-horizontal rounded shadow-lg">
                ...
                <p class="text-center mt-2">Ainda não é cadastrado? <a href="/candidate/new">Clique Aqui!</a></p>
            </form>
    ...
    methods: {
        async login() {
            try {
                ...
                this.$router.push({ path: '/candidate/vacancies' })
            } catch (error) {
